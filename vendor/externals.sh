...
${cmd} git cubew -b v4.8-rc2 https://gitlab.jsc.fz-juelich.de/perftools/cubew.git
${cmd} git cubelib -b v4.8-rc2 https://gitlab.jsc.fz-juelich.de/perftools/cubelib.git
