...
public:
     ...
     */
    virtual bool
    argMatches( const std::string& s ) const;
     ...
     */
    virtual std::string
    shortID( const std::string& valueId = "val" ) const;
     ...
     */
    virtual std::string
    longID( const std::string& valueId = "val" ) const;
     ...
     */
    bool
    _hasBlanks( const std::string& s ) const;
     ...
     */
    void
    setRequireLabel( const std::string& s );
...
inline std::string
Arg::shortID( const std::string& valueId ) const
{
    std::string id = "";
...
inline std::string
Arg::longID( const std::string& valueId ) const
{
    std::string id = "";
...
inline bool
Arg::isIgnoreable() const
{
    return _ignoreable;
}

inline void
Arg::setRequireLabel( const std::string& s )
{
    _requireLabel = s;
}

inline bool
Arg::argMatches( const std::string& argFlag ) const
{
 ...
 */
inline bool
Arg::_hasBlanks( const std::string& s ) const
{
 ...
 */
inline void
Arg::addToList( std::list<Arg*>& argList ) const
{
