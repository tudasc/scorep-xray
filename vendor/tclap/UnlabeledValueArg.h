...
template<class T>
bool
UnlabeledValueArg<T>::processArg( int*                      i,
                                  std::vector<std::string>& args )
{
    if ( _alreadySet )
    {
...
template<class T>
std::string
UnlabeledValueArg<T>::shortID( const std::string& val ) const
{
...
template<class T>
std::string
UnlabeledValueArg<T>::longID( const std::string& val ) const
{
    static_cast<void>( val );   // Ignore input, don't warn
...
template<class T>
bool
UnlabeledValueArg<T>::operator==( const Arg& a ) const
{
...
template<class T>
void
UnlabeledValueArg<T>::addToList( std::list<Arg*>& argList ) const
{
