...
protected:
    ...
    std::string
    getMutexList( CmdLineInterface& _cmd,
                  Arg*              a );
    void
    printOption( Arg*        it,
                 std::string mutex );
...
inline void
ZshCompletionOutput::failure( CmdLineInterface& _cmd,
                              ArgException&     e )
{
...
inline void
ZshCompletionOutput::printOption( Arg*        a,
                                  std::string mutex )
{
...
inline std::string
ZshCompletionOutput::getMutexList( CmdLineInterface& _cmd,
                                   Arg*              a )
{
