...
protected:
     ...
     */
    void
    substituteSpecialChars( std::string& s,
                            char         r,
                            std::string& x );
    void
    removeChar( std::string& s,
                char         r );
    void
...
inline void
DocBookOutput::failure( CmdLineInterface& _cmd,
                        ArgException&     e )
{
...
inline void
DocBookOutput::substituteSpecialChars( std::string& s,
                                       char         r,
                                       std::string& x )
{
    size_t p;
...
inline void
DocBookOutput::removeChar( std::string& s,
                           char         r )
{
    size_t p;
    while ( ( p = s.find_first_of( r ) ) != std::string::npos )
