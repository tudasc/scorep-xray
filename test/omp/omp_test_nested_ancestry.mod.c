...
#line 1 "omp_test_nested_ancestry.c"
/*
...
int outer, middle;
#line 45 "omp_test_nested_ancestry.c"
...
#line 78 "omp_test_nested_ancestry.c"
...
#line 79 "omp_test_nested_ancestry.c"
        {
...
#line 81 "omp_test_nested_ancestry.c"
...
#line 82 "omp_test_nested_ancestry.c"
          {
{   POMP2_Atomic_enter( &pomp2_region_4, pomp2_ctc_4  );
#line 83 "omp_test_nested_ancestry.c"
#pragma omp atomic
            sum += foo(i);
  POMP2_Atomic_exit( &pomp2_region_4 );
 }
#line 85 "omp_test_nested_ancestry.c"
          }
{ POMP2_Task_handle pomp2_old_task;
...
#line 86 "omp_test_nested_ancestry.c"
        }
{ POMP2_Task_handle pomp2_old_task;
...
#line 87 "omp_test_nested_ancestry.c"
      }
{ POMP2_Task_handle pomp2_old_task;
...
#line 88 "omp_test_nested_ancestry.c"
    }
  printf("Sum=%f\n", sum);
...
#line 94 "omp_test_nested_ancestry.c"
...
#line 95 "omp_test_nested_ancestry.c"
      {
        outer = omp_get_thread_num();
{
  int pomp2_num_threads = 2;
...
#line 97 "omp_test_nested_ancestry.c"
...
#line 98 "omp_test_nested_ancestry.c"
        {
          middle = omp_get_thread_num();
{   POMP2_Atomic_enter( &pomp2_region_7, pomp2_ctc_7  );
#line 100 "omp_test_nested_ancestry.c"
#pragma omp atomic
          sum += foo(i);
  POMP2_Atomic_exit( &pomp2_region_7 );
 }
#line 102 "omp_test_nested_ancestry.c"
        }
{ POMP2_Task_handle pomp2_old_task;
...
#line 103 "omp_test_nested_ancestry.c"
      }
{ POMP2_Task_handle pomp2_old_task;
...
#line 104 "omp_test_nested_ancestry.c"
    }
  printf("Sum=%f\n", sum);
...
#line 110 "omp_test_nested_ancestry.c"
...
#line 111 "omp_test_nested_ancestry.c"
      {
        outer = omp_get_thread_num();
{
  int pomp2_num_threads = 4;
...
#line 113 "omp_test_nested_ancestry.c"
...
#line 114 "omp_test_nested_ancestry.c"
        {
{   POMP2_Atomic_enter( &pomp2_region_10, pomp2_ctc_10  );
#line 115 "omp_test_nested_ancestry.c"
#pragma omp atomic
          sum += foo(i);
  POMP2_Atomic_exit( &pomp2_region_10 );
 }
#line 117 "omp_test_nested_ancestry.c"
        }
{ POMP2_Task_handle pomp2_old_task;
...
#line 118 "omp_test_nested_ancestry.c"
      }
{ POMP2_Task_handle pomp2_old_task;
...
#line 119 "omp_test_nested_ancestry.c"
    }
