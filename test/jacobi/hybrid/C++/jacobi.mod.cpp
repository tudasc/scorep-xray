...
#line 1 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
/*
 ******************************************************************
    ...
    if ( uold )
    {
        ...
        while ( data.iIterCount < data.iIterMax && residual > data.fTolerance )
        {
            ...
            ExchangeJacobiMpiData( data, uold, request, status );
            {
                ...
                POMP2_Parallel_fork( &pomp2_region_1, pomp_if, pomp_num_threads, &pomp2_old_task, "217*regionType=parallel*sscl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:67:67*escl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:0:0**" );
#line 67 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
...
#line 68 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
                  {
                      double fLRes;

                      /* compute stencil, residual and update */
                      POMP2_For_enter( &pomp2_region_2, "240*regionType=for*sscl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:72:72*escl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:0:0*hasReduction=1*hasOrdered=1**"  );
#line 72 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
...
#line 88 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
                  }
                  { POMP2_Task_handle pomp2_old_task;
                       ...
                       MPI_Status*  status )
{
    ...
    }
    {
        ...
        int               pomp_if          = 1;
        POMP2_Task_handle pomp2_old_task;
        POMP2_Parallel_fork( &pomp2_region_3, pomp_if, pomp_num_threads, &pomp2_old_task, "222*regionType=parallelfor*sscl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:154:154*escl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:0:0**" );
#line 154 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
#pragma omp parallel     POMP2_DLIST_00003 firstprivate(pomp2_old_task) if(pomp_if) num_threads(pomp_num_threads) copyin(FORTRAN_MANGLED(pomp_tpd))
        { POMP2_Parallel_begin( &pomp2_region_3 );
          POMP2_For_enter( &pomp2_region_3, "222*regionType=parallelfor*sscl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:154:154*escl=/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp:0:0**"  );
#line 154 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
...
#line 162 "/rwthfs/rz/cluster/home/ds534486/SILC/silc-root/trunk/test/jacobi/hybrid/C++/jacobi.cpp"
