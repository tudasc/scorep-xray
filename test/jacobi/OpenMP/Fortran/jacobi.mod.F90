...
#line 82 "jacobi.F90"
      ...
      subroutine POMP2_Init_regions_1276000369681619_3()
         include 'jacobi.F90.opari.inc'
         call POMP2_Assign_handle( pomp_region_1, "66*regionType=parallel*sscl=jacobi.F90:56:56*escl=jacobi.F90:81:81**" );
         call POMP2_Assign_handle( pomp_region_2, "60*regionType=do*sscl=jacobi.F90:57:57*escl=jacobi.F90:63:63**" );
         call POMP2_Assign_handle( pomp_region_3, "60*regionType=do*sscl=jacobi.F90:64:64*escl=jacobi.F90:80:80**" );
      end subroutine
