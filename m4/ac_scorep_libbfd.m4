...
dnl helper macro for AC_SCOREP_LIBBFD
...
AS_IF([test "x${scorep_compiler_gnu}" = "xyes" || test "x${scorep_compiler_intel}" = "xyes"], 
      [AS_IF([test "x${ac_scorep_cross_compiling}" = "xyes"],
       ...
       AS_IF([test "x${ac_cv_header_bfd_h}" = "xyes"],
                    ...
                    [AC_MSG_RESULT([${LIBS}])
                     ...
                     AC_LINK_IFELSE([AC_LANG_PROGRAM([[char* cplus_demangle( const char* mangled, int options );]],
                                    ...
                                    [scorep_have_demangle="yes"
                                     AC_SCOREP_SUMMARY([compiler instrumentation], 
                                                       [yes, using libbfd (${scorep_bfd_libs}) and cplus_demangle])],
                                    [scorep_have_demangle="no"
                                     AC_SCOREP_SUMMARY([compiler instrumentation], 
                                                       [yes, using libbfd (${scorep_bfd_libs})])])
      ...
      [AC_SCOREP_SUMMARY([compiler instrumentation], [partially, studio compiler supports just Fortran])]
      [AC_SCOREP_SUMMARY([compiler instrumentation], [yes])])
