            ...
            [AS_IF([test "x${ac_scorep_cross_compiling}" = "xno"],
                   [ac_scorep_compilers_backend="compiler-nocross-gcc" # default
                    AS_CASE([$withval],
                            ...
                            ["pgi"],       [AS_IF([test "x${build_cpu}" = "xpowerpc64le"],
                                                  [ac_scorep_compilers_backend="compiler-nocross-pgipower"],
                                                  [ac_scorep_compilers_backend="compiler-nocross-pgi"])],
            ...
            [AS_IF([test "x${ac_scorep_cross_compiling}" = "xyes"],
                   [ac_scorep_compilers_frontend="compiler-frontend-gcc"
                    AS_CASE([$withval],
                            ...
                            ["pgi"],       [AS_IF([test "x${build_cpu}" = "xpowerpc64le"],
                                                  [ac_scorep_compilers_frontend="compiler-frontend-pgipower"],
                                                  [ac_scorep_compilers_frontend="compiler-frontend-pgi"])],
