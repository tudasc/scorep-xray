...
int32_t test_ascii_write( char* buffer, uint32_t wlen, uint32_t num );
int32_t test_ascii_read( char* buffer, uint32_t num );
inline char* ascii_write_uint32( char* p, uint32_t value );
inline char* ascii_write_uint64( char* p, uint64_t value );
inline char* ascii_write_keyword( char* p, char keyword );
inline char* ascii_write_newline( char* p );
inline char* ascii_read_uint32( char* p, uint32_t* value );
inline char* ascii_read_uint64( char* p, uint64_t* value );
inline char* ascii_read_keyword( char* p, char* value );
inline char* ascii_read_newline( char* p );

int32_t test_binA_write( char* buffer, uint32_t wlen, uint32_t num );
int32_t test_binA_read( char* buffer, uint32_t num );
inline char* binA_write_uint8( char* pos, uint8_t value );
inline char* binA_write_uint32( char* pos, uint32_t value );
inline char* binA_write_uint64( char* pos, uint64_t value );
inline char* binA_read_uint8( char* pos, uint8_t* value );
inline char* binA_read_uint32( char* pos, uint32_t* value );
inline char* binA_read_uint64( char* pos, uint64_t* value );

int32_t test_binB_write( char* buffer, uint32_t wlen, uint32_t num );
int32_t test_binB_read( char* buffer, uint32_t num );
inline char* binB_write_uint8( char* pos, uint8_t value );
inline char* binB_write_uint32( char* pos, uint32_t value );
inline char* binB_write_uint64( char* pos, uint64_t value );
inline char* binB_read_uint8( char* pos, uint8_t* value );
inline char* binB_read_uint32( char* pos, uint32_t* value );
inline char* binB_read_uint64( char* pos, uint64_t* value );

int32_t test_binC_write( char* buffer, uint32_t wlen, uint32_t num );
int32_t test_binC_read( char* buffer, uint32_t num );
inline char* binC_write_uint8( char* pos, uint8_t value );
inline char* binC_write_uint32( char* pos, uint32_t value );
inline char* binC_write_uint64( char* pos, uint64_t value );
inline char* binC_read_uint8( char* pos, uint8_t* value );
inline char* binC_read_uint32( char* pos, uint32_t* value );
inline char* binC_read_uint64( char* pos, uint64_t* value );

int32_t test_binD_write( char* buffer, uint32_t wlen, uint32_t num );
int32_t test_binD_read( char* buffer, uint32_t num );
inline char* binD_write_uint8( char* pos, uint8_t value );
inline char* binD_write_uint32( char* pos, uint32_t value );
inline char* binD_write_uint64( char* pos, uint64_t value );
inline char* binD_read_uint8( char* pos, uint8_t* value );
inline char* binD_read_uint32( char* pos, uint32_t* value );
inline char* binD_read_uint64( char* pos, uint64_t* value );

int call_record( char keyword, uint64_t timestamp, uint32_t region_id);
...
int main( int argc, const char** args ) {
    ...
    /* ascii */
        ...
        write_duration= timeB.tv_sec - timeA.tv_sec + 0.000001 * ( timeB.tv_usec - timeA.tv_usec );
        ...
        gettimeofday( &timeB, NULL );
        read_duration= timeB.tv_sec - timeA.tv_sec + 0.000001 * ( timeB.tv_usec - timeA.tv_usec );
        
        assert( rlen >= 0 );
        
        gettimeofday( &timeA, NULL );
        zbuffersize= buffersize;
        ret= compress2( zbuffer, &zbuffersize, buffer, wlen, COMPRESSIONLEVEL );
        assert( Z_OK == ret );
        gettimeofday( &timeB, NULL );
        zip_duration= timeB.tv_sec - timeA.tv_sec + 0.000001 * ( timeB.tv_usec - timeA.tv_usec );
        ...
        assert( wlen == wlen2 );
        gettimeofday( &timeB, NULL );
        unzip_duration= timeB.tv_sec - timeA.tv_sec + 0.000001 * ( timeB.tv_usec - timeA.tv_usec );
        ...
        fprintf( stdout, 
            ...
            "%6.2f B/R \t"
            "%7.3f MR/s\n\n", 
            wlen/1024.0/1024.0, write_duration, wlen/(float)num, num/(float)write_duration/1e6,
            rlen/1024.0/1024.0, read_duration, rlen/(float)num, num/(float)read_duration/1e6,
			COMPRESSIONLEVEL,
            zbuffersize/1024.0/1024.0, zip_duration, zbuffersize/(float)num, num/(float)zip_duration/1e6,
            wlen2/1024.0/1024.0, unzip_duration, wlen2/(float)num, num/(float)unzip_duration/1e6 );            
...
int32_t test_binD_write( char* buffer, uint32_t len, uint32_t num ) {
