...
{
    return SCOREP_Task_GetProfileData( task );
}
...
scorep_profile_alloc_new_task( SCOREP_Location*             locationData,
                               ...
                               SCOREP_TaskHandle taskHandle )
{
    ...
    if ( new_task == NULL )
    {
        new_task = scorep_profile_alloc_new_task( locationData, location );
    }
