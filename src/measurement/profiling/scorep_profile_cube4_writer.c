...
init_cube_writing_data( scorep_cube_writing_data* write_set )
{
    ...
    SCOREP_Ipc_Reduce( &write_set->local_threads, &write_set->global_threads,
                       1, SCOREP_IPC_UNSIGNED, SCOREP_IPC_SUM, 0 );
    ...
    SCOREP_Ipc_Scan( &write_set->local_threads, &write_set->offset, 1,
                     SCOREP_IPC_UNSIGNED, SCOREP_IPC_SUM );
    ...
    SCOREP_Ipc_Bcast( &write_set->num_unified, 1, SCOREP_IPC_UNSIGNED, 0 );
