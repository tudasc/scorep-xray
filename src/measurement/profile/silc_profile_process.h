...
#ifndef SILC_PROFILE_PROCESS_H
#define SILC_PROFILE_PROCESS_H

/**
 * @file silc_profile_process.h
...
/**
   ...
   execute @ref silc_profile_assign_callpath_to_master().
 */
extern void
silc_profile_assign_callpath_to_workers();

#endif // SILC_PROFILE_PROCESS_H
