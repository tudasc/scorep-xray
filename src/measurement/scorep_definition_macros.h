...
/**
 * Allocate, assign the sequence number, and store in definition manager list
 * @a definition_manager a new definition of definition type @a type
 *
 * @needs Variable with name @a new_handle of handle type @a Type.
 * @needs Variable with name @a new_definition of definition type @a Type*.
 *
 ...
 */
/* *INDENT-OFF* */
#define SCOREP_ALLOC_NEW_DEFINITION_OLD( Type, type, definition_manager ) \
    do \
    { \
        new_handle = SCOREP_Memory_AllocForDefinitions( \
            sizeof( SCOREP_ ## Type ## _Definition ) ); \
...
/**
 * Allocate, assign the sequence number, and store in definition manager list
 * a new definition of type @type with a variable array member of type
 * @array_type and a total number of members of @number_of_members
 *
 * @needs Variable with name @a new_handle of handle type @a Type.
 * @needs Variable with name @a new_definition of definition type @a Type*.
 *
 ...
 */
#define SCOREP_DEFINITION_DEFINE_TEMP_OLD( Type  ) \
    SCOREP_ ## Type ## _Definition tmp_definition_storage; \
    SCOREP_ ## Type ## _Definition * tmp_definition = \
        &tmp_definition_storage; \
