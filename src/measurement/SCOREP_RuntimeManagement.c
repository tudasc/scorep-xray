...
scorep_profile_initialize()
{
    ...
    SCOREP_Profile_OnLocationCreation( SCOREP_Location_GetCurrentCPUThreadData(), NULL ); // called also from scorep_thread_call_externals_on_new_location
    SCOREP_Profile_OnThreadActivation( SCOREP_Location_GetCurrentCPUThreadData(), NULL ); // called also from scorep_thread_call_externals_on_thread_activation
}
...
{
    SCOREP_Location* location = SCOREP_Location_GetCurrentCPUThreadData();
