...
const static SCOREP_Substrates_Callback substrate_callbacks[ SCOREP_SUBSTRATES_NUM_MODES ][ SCOREP_SUBSTRATES_NUM_EVENTS ] =
{
    {   /* SCOREP_SUBSTRATES_RECORDING_ENABLED */
        SCOREP_ASSIGN_CALLBACK( InitSubstrate,            INIT_SUBSTRATE,               SCOREP_Tracing_Initialize ),
        SCOREP_ASSIGN_CALLBACK( FinalizeSubstrate,        FINALIZE_SUBSTRATE,           SCOREP_Tracing_Finalize ),
        SCOREP_ASSIGN_CALLBACK( DisableRecording,         DISABLE_RECORDING,            disable_recording ),
        SCOREP_ASSIGN_CALLBACK( OnLocationCreation,       ON_LOCATION_CREATION,         SCOREP_Tracing_OnLocationCreation ),
        SCOREP_ASSIGN_CALLBACK( OnLocationDeletion,       ON_LOCATION_DELETION,         SCOREP_Tracing_DeleteLocationData ),
        SCOREP_ASSIGN_CALLBACK( PreUnifySubstrate,        PRE_UNIFY_SUBSTRATE,          SCOREP_Tracing_FinalizeEventWriters ),
        SCOREP_ASSIGN_CALLBACK( WriteData,                WRITE_DATA,                   SCOREP_Tracing_Write ),
        SCOREP_ASSIGN_CALLBACK( InitializeMpp,            INITIALIZE_MPP,               SCOREP_Tracing_OnMppInit ),
        SCOREP_ASSIGN_CALLBACK( EnsureGlobalId,           ENSURE_GLOBAL_ID,             SCOREP_Tracing_AssignLocationId ),
        SCOREP_ASSIGN_CALLBACK( EnterRegion,              ENTER_REGION,                 enter ),
        SCOREP_ASSIGN_CALLBACK( ExitRegion,               EXIT_REGION,                  leave ),
        SCOREP_ASSIGN_CALLBACK( EnterRewindRegion,        ENTER_REWIND_REGION,          store_rewind_point ),
        SCOREP_ASSIGN_CALLBACK( ExitRewindRegion,         EXIT_REWIND_REGION,           exit_rewind_point ),
        SCOREP_ASSIGN_CALLBACK( MpiSend,                  MPI_SEND,                     mpi_send ),
        SCOREP_ASSIGN_CALLBACK( MpiRecv,                  MPI_RECV,                     mpi_recv ),
        SCOREP_ASSIGN_CALLBACK( MpiCollectiveBegin,       MPI_COLLECTIVE_BEGIN,         mpi_collective_begin ),
        SCOREP_ASSIGN_CALLBACK( MpiCollectiveEnd,         MPI_COLLECTIVE_END,           mpi_collective_end ),
        SCOREP_ASSIGN_CALLBACK( MpiIsendComplete,         MPI_ISEND_COMPLETE,           mpi_isend_complete ),
        SCOREP_ASSIGN_CALLBACK( MpiIrecvRequest,          MPI_IRECV_REQUEST,            mpi_irecv_request ),
        SCOREP_ASSIGN_CALLBACK( MpiRequestTested,         MPI_REQUEST_TESTED,           mpi_request_tested ),
        SCOREP_ASSIGN_CALLBACK( MpiRequestCancelled,      MPI_REQUEST_CANCELLED,        mpi_request_cancelled ),
        SCOREP_ASSIGN_CALLBACK( MpiIsend,                 MPI_ISEND,                    mpi_isend ),
        SCOREP_ASSIGN_CALLBACK( MpiIrecv,                 MPI_IRECV,                    mpi_irecv ),
        SCOREP_ASSIGN_CALLBACK( RmaWinCreate,             RMA_WIN_CREATE,               rma_win_create ),
        SCOREP_ASSIGN_CALLBACK( RmaWinDestroy,            RMA_WIN_DESTROY,              rma_win_destroy ),
        SCOREP_ASSIGN_CALLBACK( RmaCollectiveBegin,       RMA_COLLECTIVE_BEGIN,         rma_collective_begin ),
        SCOREP_ASSIGN_CALLBACK( RmaCollectiveEnd,         RMA_COLLECTIVE_END,           rma_collective_end ),
        SCOREP_ASSIGN_CALLBACK( RmaTryLock,               RMA_TRY_LOCK,                 rma_try_lock ),
        SCOREP_ASSIGN_CALLBACK( RmaAcquireLock,           RMA_ACQUIRE_LOCK,             rma_acquire_lock ),
        SCOREP_ASSIGN_CALLBACK( RmaRequestLock,           RMA_REQUEST_LOCK,             rma_request_lock ),
        SCOREP_ASSIGN_CALLBACK( RmaReleaseLock,           RMA_RELEASE_LOCK,             rma_release_lock ),
        SCOREP_ASSIGN_CALLBACK( RmaSync,                  RMA_SYNC,                     rma_sync ),
        SCOREP_ASSIGN_CALLBACK( RmaGroupSync,             RMA_GROUP_SYNC,               rma_group_sync ),
        SCOREP_ASSIGN_CALLBACK( RmaPut,                   RMA_PUT,                      rma_put ),
        SCOREP_ASSIGN_CALLBACK( RmaGet,                   RMA_GET,                      rma_get ),
        SCOREP_ASSIGN_CALLBACK( RmaAtomic,                RMA_ATOMIC,                   rma_atomic ),
        SCOREP_ASSIGN_CALLBACK( RmaWaitChange,            RMA_WAIT_CHANGE,              rma_wait_change ),
        SCOREP_ASSIGN_CALLBACK( RmaOpCompleteBlocking,    RMA_OP_COMPLETE_BLOCKING,     rma_op_complete_blocking ),
        SCOREP_ASSIGN_CALLBACK( RmaOpCompleteNonBlocking, RMA_OP_COMPLETE_NON_BLOCKING, rma_op_complete_non_blocking ),
        SCOREP_ASSIGN_CALLBACK( RmaOpTest,                RMA_OP_TEST,                  rma_op_test ),
        SCOREP_ASSIGN_CALLBACK( RmaOpCompleteRemote,      RMA_OP_COMPLETE_REMOTE,       rma_op_complete_remote ),
        SCOREP_ASSIGN_CALLBACK( ThreadAcquireLock,        THREAD_ACQUIRE_LOCK,          thread_acquire_lock ),
        SCOREP_ASSIGN_CALLBACK( ThreadReleaseLock,        THREAD_RELEASE_LOCK,          thread_release_lock ),
        SCOREP_ASSIGN_CALLBACK( TriggerCounterInt64,      TRIGGER_COUNTER_INT64,        trigger_counter_int64 ),
        SCOREP_ASSIGN_CALLBACK( TriggerCounterUint64,     TRIGGER_COUNTER_UINT64,       trigger_counter_uint64 ),
        SCOREP_ASSIGN_CALLBACK( TriggerCounterDouble,     TRIGGER_COUNTER_DOUBLE,       trigger_counter_double ),
        SCOREP_ASSIGN_CALLBACK( TriggerParameterInt64,    TRIGGER_PARAMETER_INT64,      parameter_int64 ),
        SCOREP_ASSIGN_CALLBACK( TriggerParameterUint64,   TRIGGER_PARAMETER_UINT64,     parameter_uint64 ),
        SCOREP_ASSIGN_CALLBACK( TriggerParameterString,   TRIGGER_PARAMETER_STRING,     parameter_string ),
        ...
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTeamBegin,  THREAD_FORK_JOIN_TEAM_BEGIN,  thread_team_begin ),
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTeamEnd,    THREAD_FORK_JOIN_TEAM_END,    thread_team_end ),
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTaskCreate, THREAD_FORK_JOIN_TASK_CREATE, thread_task_create ),
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTaskSwitch, THREAD_FORK_JOIN_TASK_SWITCH, thread_task_switch ),
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTaskBegin,  THREAD_FORK_JOIN_TASK_BEGIN,  thread_task_begin ),
        SCOREP_ASSIGN_CALLBACK( ThreadForkJoinTaskEnd,    THREAD_FORK_JOIN_TASK_END,    thread_task_complete ),
        SCOREP_ASSIGN_CALLBACK( ThreadCreateWaitCreate,   THREAD_CREATE_WAIT_CREATE,    thread_create ),
        SCOREP_ASSIGN_CALLBACK( ThreadCreateWaitWait,     THREAD_CREATE_WAIT_WAIT,      thread_wait ),
        ...
        SCOREP_ASSIGN_CALLBACK( AddAttribute,             ADD_ATTRIBUTE,                add_attribute )
    },
