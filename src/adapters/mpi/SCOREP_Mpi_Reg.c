...
scorep_mpi_register_regions()
{
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_ACCUMULATE ] =
            SCOREP_DefineRegion( "MPI_Accumulate",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ADD_ERROR_CLASS ] =
            SCOREP_DefineRegion( "MPI_Add_error_class",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ADD_ERROR_CODE ] =
            SCOREP_DefineRegion( "MPI_Add_error_code",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ADD_ERROR_STRING ] =
            SCOREP_DefineRegion( "MPI_Add_error_string",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_ADDRESS ] =
            SCOREP_DefineRegion( "MPI_Address",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLGATHER ] =
            SCOREP_DefineRegion( "MPI_Allgather",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLGATHERV ] =
            SCOREP_DefineRegion( "MPI_Allgatherv",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLOC_MEM ] =
            SCOREP_DefineRegion( "MPI_Alloc_mem",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLREDUCE ] =
            SCOREP_DefineRegion( "MPI_Allreduce",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLTOALL ] =
            SCOREP_DefineRegion( "MPI_Alltoall",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLTOALLV ] =
            SCOREP_DefineRegion( "MPI_Alltoallv",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_ALLTOALLW ] =
            SCOREP_DefineRegion( "MPI_Alltoallw",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_ATTR_DELETE ] =
            SCOREP_DefineRegion( "MPI_Attr_delete",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_ATTR_GET ] =
            SCOREP_DefineRegion( "MPI_Attr_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_ATTR_PUT ] =
            SCOREP_DefineRegion( "MPI_Attr_put",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_BARRIER ] =
            SCOREP_DefineRegion( "MPI_Barrier",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_BSEND_INIT ] =
            SCOREP_DefineRegion( "MPI_Bsend_init",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_BUFFER_ATTACH ] =
            SCOREP_DefineRegion( "MPI_Buffer_attach",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_BUFFER_DETACH ] =
            SCOREP_DefineRegion( "MPI_Buffer_detach",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_CANCEL ] =
            SCOREP_DefineRegion( "MPI_Cancel",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_COORDS ] =
            SCOREP_DefineRegion( "MPI_Cart_coords",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_CREATE ] =
            SCOREP_DefineRegion( "MPI_Cart_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_GET ] =
            SCOREP_DefineRegion( "MPI_Cart_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_MAP ] =
            SCOREP_DefineRegion( "MPI_Cart_map",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_RANK ] =
            SCOREP_DefineRegion( "MPI_Cart_rank",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_SHIFT ] =
            SCOREP_DefineRegion( "MPI_Cart_shift",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CART_SUB ] =
            SCOREP_DefineRegion( "MPI_Cart_sub",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_CARTDIM_GET ] =
            SCOREP_DefineRegion( "MPI_Cartdim_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_CLOSE_PORT ] =
            SCOREP_DefineRegion( "MPI_Close_port",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_ACCEPT ] =
            SCOREP_DefineRegion( "MPI_Comm_accept",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_C2F ] =
            SCOREP_DefineRegion( "MPI_Comm_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_CALL_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Comm_call_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_COMPARE ] =
            SCOREP_DefineRegion( "MPI_Comm_compare",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_CONNECT ] =
            SCOREP_DefineRegion( "MPI_Comm_connect",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_CREATE ] =
            SCOREP_DefineRegion( "MPI_Comm_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_CREATE_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Comm_create_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_CREATE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Comm_create_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_DELETE_ATTR ] =
            SCOREP_DefineRegion( "MPI_Comm_delete_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_DISCONNECT ] =
            SCOREP_DefineRegion( "MPI_Comm_disconnect",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_DUP ] =
            SCOREP_DefineRegion( "MPI_Comm_dup",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_F2C ] =
            SCOREP_DefineRegion( "MPI_Comm_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_FREE ] =
            SCOREP_DefineRegion( "MPI_Comm_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_FREE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Comm_free_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_GET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Comm_get_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_GET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Comm_get_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_GET_NAME ] =
            SCOREP_DefineRegion( "MPI_Comm_get_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_GET_PARENT ] =
            SCOREP_DefineRegion( "MPI_Comm_get_parent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_GROUP ] =
            SCOREP_DefineRegion( "MPI_Comm_group",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_JOIN ] =
            SCOREP_DefineRegion( "MPI_Comm_join",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_RANK ] =
            SCOREP_DefineRegion( "MPI_Comm_rank",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_REMOTE_GROUP ] =
            SCOREP_DefineRegion( "MPI_Comm_remote_group",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_REMOTE_SIZE ] =
            SCOREP_DefineRegion( "MPI_Comm_remote_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Comm_set_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Comm_set_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SET_NAME ] =
            SCOREP_DefineRegion( "MPI_Comm_set_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SIZE ] =
            SCOREP_DefineRegion( "MPI_Comm_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SPAWN ] =
            SCOREP_DefineRegion( "MPI_Comm_spawn",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SPAWN_MULTIPLE ] =
            SCOREP_DefineRegion( "MPI_Comm_spawn_multiple",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_SPLIT ] =
            SCOREP_DefineRegion( "MPI_Comm_split",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_COMM_TEST_INTER ] =
            SCOREP_DefineRegion( "MPI_Comm_test_inter",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_DIMS_CREATE ] =
            SCOREP_DefineRegion( "MPI_Dims_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_DIST_GRAPH_CREATE ] =
            SCOREP_DefineRegion( "MPI_Dist_graph_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_DIST_GRAPH_CREATE_ADJACENT ] =
            SCOREP_DefineRegion( "MPI_Dist_graph_create_adjacent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_DIST_GRAPH_NEIGHBORS ] =
            SCOREP_DefineRegion( "MPI_Dist_graph_neighbors",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_DIST_GRAPH_NEIGHBORS_COUNT ] =
            SCOREP_DefineRegion( "MPI_Dist_graph_neighbors_count",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERRHANDLER_CREATE ] =
            SCOREP_DefineRegion( "MPI_Errhandler_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERRHANDLER_FREE ] =
            SCOREP_DefineRegion( "MPI_Errhandler_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERRHANDLER_GET ] =
            SCOREP_DefineRegion( "MPI_Errhandler_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERRHANDLER_SET ] =
            SCOREP_DefineRegion( "MPI_Errhandler_set",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERROR_CLASS ] =
            SCOREP_DefineRegion( "MPI_Error_class",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_ERROR_STRING ] =
            SCOREP_DefineRegion( "MPI_Error_string",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_EXSCAN ] =
            SCOREP_DefineRegion( "MPI_Exscan",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_C2F ] =
            SCOREP_DefineRegion( "MPI_File_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_CALL_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_File_call_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_CLOSE ] =
            SCOREP_DefineRegion( "MPI_File_close",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_CREATE_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_File_create_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_DELETE ] =
            SCOREP_DefineRegion( "MPI_File_delete",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_F2C ] =
            SCOREP_DefineRegion( "MPI_File_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_AMODE ] =
            SCOREP_DefineRegion( "MPI_File_get_amode",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_ATOMICITY ] =
            SCOREP_DefineRegion( "MPI_File_get_atomicity",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_BYTE_OFFSET ] =
            SCOREP_DefineRegion( "MPI_File_get_byte_offset",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_File_get_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_GROUP ] =
            SCOREP_DefineRegion( "MPI_File_get_group",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_INFO ] =
            SCOREP_DefineRegion( "MPI_File_get_info",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_POSITION ] =
            SCOREP_DefineRegion( "MPI_File_get_position",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_POSITION_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_get_position_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_SIZE ] =
            SCOREP_DefineRegion( "MPI_File_get_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_TYPE_EXTENT ] =
            SCOREP_DefineRegion( "MPI_File_get_type_extent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_GET_VIEW ] =
            SCOREP_DefineRegion( "MPI_File_get_view",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IREAD ] =
            SCOREP_DefineRegion( "MPI_File_iread",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IREAD_AT ] =
            SCOREP_DefineRegion( "MPI_File_iread_at",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IREAD_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_iread_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IWRITE ] =
            SCOREP_DefineRegion( "MPI_File_iwrite",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IWRITE_AT ] =
            SCOREP_DefineRegion( "MPI_File_iwrite_at",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_IWRITE_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_iwrite_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_OPEN ] =
            SCOREP_DefineRegion( "MPI_File_open",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_PREALLOCATE ] =
            SCOREP_DefineRegion( "MPI_File_preallocate",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ ] =
            SCOREP_DefineRegion( "MPI_File_read",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ALL ] =
            SCOREP_DefineRegion( "MPI_File_read_all",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ALL_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_read_all_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ALL_END ] =
            SCOREP_DefineRegion( "MPI_File_read_all_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_AT ] =
            SCOREP_DefineRegion( "MPI_File_read_at",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_AT_ALL ] =
            SCOREP_DefineRegion( "MPI_File_read_at_all",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_AT_ALL_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_read_at_all_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_AT_ALL_END ] =
            SCOREP_DefineRegion( "MPI_File_read_at_all_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ORDERED ] =
            SCOREP_DefineRegion( "MPI_File_read_ordered",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ORDERED_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_read_ordered_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_ORDERED_END ] =
            SCOREP_DefineRegion( "MPI_File_read_ordered_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_READ_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_read_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SEEK ] =
            SCOREP_DefineRegion( "MPI_File_seek",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SEEK_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_seek_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SET_ATOMICITY ] =
            SCOREP_DefineRegion( "MPI_File_set_atomicity",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_File_set_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SET_INFO ] =
            SCOREP_DefineRegion( "MPI_File_set_info",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SET_SIZE ] =
            SCOREP_DefineRegion( "MPI_File_set_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SET_VIEW ] =
            SCOREP_DefineRegion( "MPI_File_set_view",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_SYNC ] =
            SCOREP_DefineRegion( "MPI_File_sync",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE ] =
            SCOREP_DefineRegion( "MPI_File_write",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ALL ] =
            SCOREP_DefineRegion( "MPI_File_write_all",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ALL_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_write_all_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ALL_END ] =
            SCOREP_DefineRegion( "MPI_File_write_all_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_AT ] =
            SCOREP_DefineRegion( "MPI_File_write_at",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_AT_ALL ] =
            SCOREP_DefineRegion( "MPI_File_write_at_all",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_AT_ALL_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_write_at_all_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_AT_ALL_END ] =
            SCOREP_DefineRegion( "MPI_File_write_at_all_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ORDERED ] =
            SCOREP_DefineRegion( "MPI_File_write_ordered",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ORDERED_BEGIN ] =
            SCOREP_DefineRegion( "MPI_File_write_ordered_begin",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_ORDERED_END ] =
            SCOREP_DefineRegion( "MPI_File_write_ordered_end",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_FILE_WRITE_SHARED ] =
            SCOREP_DefineRegion( "MPI_File_write_shared",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_FINALIZE ] =
            SCOREP_DefineRegion( "MPI_Finalize",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_FINALIZED ] =
            SCOREP_DefineRegion( "MPI_Finalized",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_FREE_MEM ] =
            SCOREP_DefineRegion( "MPI_Free_mem",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_GATHER ] =
            SCOREP_DefineRegion( "MPI_Gather",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_GATHERV ] =
            SCOREP_DefineRegion( "MPI_Gatherv",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_GET_ADDRESS ] =
            SCOREP_DefineRegion( "MPI_Get_address",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_GET_COUNT ] =
            SCOREP_DefineRegion( "MPI_Get_count",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_GET_ELEMENTS ] =
            SCOREP_DefineRegion( "MPI_Get_elements",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_GET_PROCESSOR_NAME ] =
            SCOREP_DefineRegion( "MPI_Get_processor_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_GET_VERSION ] =
            SCOREP_DefineRegion( "MPI_Get_version",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPH_CREATE ] =
            SCOREP_DefineRegion( "MPI_Graph_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPH_GET ] =
            SCOREP_DefineRegion( "MPI_Graph_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPH_MAP ] =
            SCOREP_DefineRegion( "MPI_Graph_map",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPH_NEIGHBORS ] =
            SCOREP_DefineRegion( "MPI_Graph_neighbors",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPH_NEIGHBORS_COUNT ] =
            SCOREP_DefineRegion( "MPI_Graph_neighbors_count",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_GRAPHDIMS_GET ] =
            SCOREP_DefineRegion( "MPI_Graphdims_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_GREQUEST_COMPLETE ] =
            SCOREP_DefineRegion( "MPI_Grequest_complete",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_GREQUEST_START ] =
            SCOREP_DefineRegion( "MPI_Grequest_start",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_C2F ] =
            SCOREP_DefineRegion( "MPI_Group_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_COMPARE ] =
            SCOREP_DefineRegion( "MPI_Group_compare",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_DIFFERENCE ] =
            SCOREP_DefineRegion( "MPI_Group_difference",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_EXCL ] =
            SCOREP_DefineRegion( "MPI_Group_excl",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_F2C ] =
            SCOREP_DefineRegion( "MPI_Group_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_FREE ] =
            SCOREP_DefineRegion( "MPI_Group_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_INCL ] =
            SCOREP_DefineRegion( "MPI_Group_incl",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_INTERSECTION ] =
            SCOREP_DefineRegion( "MPI_Group_intersection",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_RANGE_EXCL ] =
            SCOREP_DefineRegion( "MPI_Group_range_excl",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_RANGE_INCL ] =
            SCOREP_DefineRegion( "MPI_Group_range_incl",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_RANK ] =
            SCOREP_DefineRegion( "MPI_Group_rank",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_SIZE ] =
            SCOREP_DefineRegion( "MPI_Group_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_TRANSLATE_RANKS ] =
            SCOREP_DefineRegion( "MPI_Group_translate_ranks",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_GROUP_UNION ] =
            SCOREP_DefineRegion( "MPI_Group_union",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_IBSEND ] =
            SCOREP_DefineRegion( "MPI_Ibsend",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_C2F ] =
            SCOREP_DefineRegion( "MPI_Info_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_CREATE ] =
            SCOREP_DefineRegion( "MPI_Info_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_DELETE ] =
            SCOREP_DefineRegion( "MPI_Info_delete",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_DUP ] =
            SCOREP_DefineRegion( "MPI_Info_dup",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_F2C ] =
            SCOREP_DefineRegion( "MPI_Info_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_FREE ] =
            SCOREP_DefineRegion( "MPI_Info_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_GET ] =
            SCOREP_DefineRegion( "MPI_Info_get",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NKEYS ] =
            SCOREP_DefineRegion( "MPI_Info_get_nkeys",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NTHKEY ] =
            SCOREP_DefineRegion( "MPI_Info_get_nthkey",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_GET_VALUELEN ] =
            SCOREP_DefineRegion( "MPI_Info_get_valuelen",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_INFO_SET ] =
            SCOREP_DefineRegion( "MPI_Info_set",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_INIT_THREAD ] =
            SCOREP_DefineRegion( "MPI_Init_thread",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_INITIALIZED ] =
            SCOREP_DefineRegion( "MPI_Initialized",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_INTERCOMM_CREATE ] =
            SCOREP_DefineRegion( "MPI_Intercomm_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG )
    {
        scorep_mpi_regid[ SCOREP__MPI_INTERCOMM_MERGE ] =
            SCOREP_DefineRegion( "MPI_Intercomm_merge",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_IPROBE ] =
            SCOREP_DefineRegion( "MPI_Iprobe",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_IRSEND ] =
            SCOREP_DefineRegion( "MPI_Irsend",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_IS_THREAD_MAIN ] =
            SCOREP_DefineRegion( "MPI_Is_thread_main",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_ISSEND ] =
            SCOREP_DefineRegion( "MPI_Issend",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_KEYVAL_CREATE ] =
            SCOREP_DefineRegion( "MPI_Keyval_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_CG_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_KEYVAL_FREE ] =
            SCOREP_DefineRegion( "MPI_Keyval_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_LOOKUP_NAME ] =
            SCOREP_DefineRegion( "MPI_Lookup_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_OP_C2F ] =
            SCOREP_DefineRegion( "MPI_Op_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_OP_COMMUTATIVE ] =
            SCOREP_DefineRegion( "MPI_Op_commutative",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_OP_CREATE ] =
            SCOREP_DefineRegion( "MPI_Op_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_OP_F2C ] =
            SCOREP_DefineRegion( "MPI_Op_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_OP_FREE ] =
            SCOREP_DefineRegion( "MPI_Op_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_OPEN_PORT ] =
            SCOREP_DefineRegion( "MPI_Open_port",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_PACK_EXTERNAL ] =
            SCOREP_DefineRegion( "MPI_Pack_external",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_PACK_EXTERNAL_SIZE ] =
            SCOREP_DefineRegion( "MPI_Pack_external_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_PACK_SIZE ] =
            SCOREP_DefineRegion( "MPI_Pack_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_PERF )
    {
        scorep_mpi_regid[ SCOREP__MPI_PCONTROL ] =
            SCOREP_DefineRegion( "MPI_Pcontrol",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_PUBLISH_NAME ] =
            SCOREP_DefineRegion( "MPI_Publish_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_ENV )
    {
        scorep_mpi_regid[ SCOREP__MPI_QUERY_THREAD ] =
            SCOREP_DefineRegion( "MPI_Query_thread",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_RECV_INIT ] =
            SCOREP_DefineRegion( "MPI_Recv_init",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_REDUCE ] =
            SCOREP_DefineRegion( "MPI_Reduce",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_REDUCE_LOCAL ] =
            SCOREP_DefineRegion( "MPI_Reduce_local",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_REDUCE_SCATTER ] =
            SCOREP_DefineRegion( "MPI_Reduce_scatter",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_REDUCE_SCATTER_BLOCK ] =
            SCOREP_DefineRegion( "MPI_Reduce_scatter_block",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_IO )
    {
        scorep_mpi_regid[ SCOREP__MPI_REGISTER_DATAREP ] =
            SCOREP_DefineRegion( "MPI_Register_datarep",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_REQUEST_C2F ] =
            SCOREP_DefineRegion( "MPI_Request_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_REQUEST_F2C ] =
            SCOREP_DefineRegion( "MPI_Request_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_REQUEST_FREE ] =
            SCOREP_DefineRegion( "MPI_Request_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_REQUEST_GET_STATUS ] =
            SCOREP_DefineRegion( "MPI_Request_get_status",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_RSEND_INIT ] =
            SCOREP_DefineRegion( "MPI_Rsend_init",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_SCATTER ] =
            SCOREP_DefineRegion( "MPI_Scatter",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_COLL )
    {
        scorep_mpi_regid[ SCOREP__MPI_SCATTERV ] =
            SCOREP_DefineRegion( "MPI_Scatterv",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_SEND_INIT ] =
            SCOREP_DefineRegion( "MPI_Send_init",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_SENDRECV ] =
            SCOREP_DefineRegion( "MPI_Sendrecv",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_SENDRECV_REPLACE ] =
            SCOREP_DefineRegion( "MPI_Sendrecv_replace",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_SIZEOF ] =
            SCOREP_DefineRegion( "MPI_Sizeof",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_SSEND_INIT ] =
            SCOREP_DefineRegion( "MPI_Ssend_init",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_STARTALL ] =
            SCOREP_DefineRegion( "MPI_Startall",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_STATUS_C2F ] =
            SCOREP_DefineRegion( "MPI_Status_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_STATUS_F2C ] =
            SCOREP_DefineRegion( "MPI_Status_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_STATUS_SET_CANCELLED ] =
            SCOREP_DefineRegion( "MPI_Status_set_cancelled",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_STATUS_SET_ELEMENTS ] =
            SCOREP_DefineRegion( "MPI_Status_set_elements",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_TEST_CANCELLED ] =
            SCOREP_DefineRegion( "MPI_Test_cancelled",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_TESTALL ] =
            SCOREP_DefineRegion( "MPI_Testall",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_TESTANY ] =
            SCOREP_DefineRegion( "MPI_Testany",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_TESTSOME ] =
            SCOREP_DefineRegion( "MPI_Testsome",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TOPO )
    {
        scorep_mpi_regid[ SCOREP__MPI_TOPO_TEST ] =
            SCOREP_DefineRegion( "MPI_Topo_test",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_C2F ] =
            SCOREP_DefineRegion( "MPI_Type_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_COMMIT ] =
            SCOREP_DefineRegion( "MPI_Type_commit",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CONTIGUOUS ] =
            SCOREP_DefineRegion( "MPI_Type_contiguous",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_DARRAY ] =
            SCOREP_DefineRegion( "MPI_Type_create_darray",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_F90_COMPLEX ] =
            SCOREP_DefineRegion( "MPI_Type_create_f90_complex",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_F90_INTEGER ] =
            SCOREP_DefineRegion( "MPI_Type_create_f90_integer",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_F90_REAL ] =
            SCOREP_DefineRegion( "MPI_Type_create_f90_real",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_HINDEXED ] =
            SCOREP_DefineRegion( "MPI_Type_create_hindexed",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_HVECTOR ] =
            SCOREP_DefineRegion( "MPI_Type_create_hvector",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_INDEXED_BLOCK ] =
            SCOREP_DefineRegion( "MPI_Type_create_indexed_block",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Type_create_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_RESIZED ] =
            SCOREP_DefineRegion( "MPI_Type_create_resized",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_STRUCT ] =
            SCOREP_DefineRegion( "MPI_Type_create_struct",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_CREATE_SUBARRAY ] =
            SCOREP_DefineRegion( "MPI_Type_create_subarray",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_DELETE_ATTR ] =
            SCOREP_DefineRegion( "MPI_Type_delete_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_DUP ] =
            SCOREP_DefineRegion( "MPI_Type_dup",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_EXTENT ] =
            SCOREP_DefineRegion( "MPI_Type_extent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_F2C ] =
            SCOREP_DefineRegion( "MPI_Type_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_FREE ] =
            SCOREP_DefineRegion( "MPI_Type_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_FREE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Type_free_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Type_get_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_CONTENTS ] =
            SCOREP_DefineRegion( "MPI_Type_get_contents",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_ENVELOPE ] =
            SCOREP_DefineRegion( "MPI_Type_get_envelope",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_EXTENT ] =
            SCOREP_DefineRegion( "MPI_Type_get_extent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_NAME ] =
            SCOREP_DefineRegion( "MPI_Type_get_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_GET_TRUE_EXTENT ] =
            SCOREP_DefineRegion( "MPI_Type_get_true_extent",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_HINDEXED ] =
            SCOREP_DefineRegion( "MPI_Type_hindexed",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_HVECTOR ] =
            SCOREP_DefineRegion( "MPI_Type_hvector",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_INDEXED ] =
            SCOREP_DefineRegion( "MPI_Type_indexed",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_LB ] =
            SCOREP_DefineRegion( "MPI_Type_lb",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_MATCH_SIZE ] =
            SCOREP_DefineRegion( "MPI_Type_match_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_SET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Type_set_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_SET_NAME ] =
            SCOREP_DefineRegion( "MPI_Type_set_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_SIZE ] =
            SCOREP_DefineRegion( "MPI_Type_size",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_STRUCT ] =
            SCOREP_DefineRegion( "MPI_Type_struct",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_UB ] =
            SCOREP_DefineRegion( "MPI_Type_ub",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_TYPE_VECTOR ] =
            SCOREP_DefineRegion( "MPI_Type_vector",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_UNPACK ] =
            SCOREP_DefineRegion( "MPI_Unpack",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_TYPE )
    {
        scorep_mpi_regid[ SCOREP__MPI_UNPACK_EXTERNAL ] =
            SCOREP_DefineRegion( "MPI_Unpack_external",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_SPAWN )
    {
        scorep_mpi_regid[ SCOREP__MPI_UNPUBLISH_NAME ] =
            SCOREP_DefineRegion( "MPI_Unpublish_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_WAITALL ] =
            SCOREP_DefineRegion( "MPI_Waitall",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_WAITANY ] =
            SCOREP_DefineRegion( "MPI_Waitany",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_P2P )
    {
        scorep_mpi_regid[ SCOREP__MPI_WAITSOME ] =
            SCOREP_DefineRegion( "MPI_Waitsome",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_C2F ] =
            SCOREP_DefineRegion( "MPI_Win_c2f",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_CALL_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Win_call_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_COMPLETE ] =
            SCOREP_DefineRegion( "MPI_Win_complete",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_CREATE ] =
            SCOREP_DefineRegion( "MPI_Win_create",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_CREATE_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Win_create_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_CREATE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Win_create_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_DELETE_ATTR ] =
            SCOREP_DefineRegion( "MPI_Win_delete_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_MISC )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_F2C ] =
            SCOREP_DefineRegion( "MPI_Win_f2c",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_FENCE ] =
            SCOREP_DefineRegion( "MPI_Win_fence",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_FREE ] =
            SCOREP_DefineRegion( "MPI_Win_free",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_FREE_KEYVAL ] =
            SCOREP_DefineRegion( "MPI_Win_free_keyval",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_GET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Win_get_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_GET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Win_get_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_GET_GROUP ] =
            SCOREP_DefineRegion( "MPI_Win_get_group",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_GET_NAME ] =
            SCOREP_DefineRegion( "MPI_Win_get_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_LOCK ] =
            SCOREP_DefineRegion( "MPI_Win_lock",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_POST ] =
            SCOREP_DefineRegion( "MPI_Win_post",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_SET_ATTR ] =
            SCOREP_DefineRegion( "MPI_Win_set_attr",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_ERR )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_SET_ERRHANDLER ] =
            SCOREP_DefineRegion( "MPI_Win_set_errhandler",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA_EXT )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_SET_NAME ] =
            SCOREP_DefineRegion( "MPI_Win_set_name",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_START ] =
            SCOREP_DefineRegion( "MPI_Win_start",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_TEST ] =
            SCOREP_DefineRegion( "MPI_Win_test",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_UNLOCK ] =
            SCOREP_DefineRegion( "MPI_Win_unlock",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
    ...
    if ( scorep_mpi_enabled & SCOREP_MPI_ENABLED_RMA )
    {
        scorep_mpi_regid[ SCOREP__MPI_WIN_WAIT ] =
            SCOREP_DefineRegion( "MPI_Win_wait",
                                 NULL,
                                 file_id,
                                 SCOREP_INVALID_LINE_NO,
                                 SCOREP_INVALID_LINE_NO,
