...
/**
   ...
   PMPI functions internally to provide the desired MPI functionality. Additinally,
   call to the measurement system are generated for measurement. To enable the
   ...
   functions o special interest provide additional events between the enter and exit
