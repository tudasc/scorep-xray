 ...
 */
void
FSUB( MPI_Type_create_f90_complex )( int*          p,
                                     int*          r,
                                     MPI_Datatype* newtype,
                                     int*          ierr )
{
 ...
 */
void
FSUB( MPI_Type_create_f90_integer )( int*          r,
                                     MPI_Datatype* newtype,
                                     int*          ierr )
{
 ...
 */
void
FSUB( MPI_Type_create_f90_real )( int*          p,
                                  int*          r,
                                  MPI_Datatype* newtype,
                                  int*          ierr )
{
...
#if HAVE( DECL_PMPI_TYPE_STRUCT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
/**
...
#if HAVE( DECL_PMPI_TYPE_CREATE_STRUCT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
/**
...
#if HAVE( DECL_PMPI_TYPE_GET_CONTENTS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
/**
 ...
 */
void
FSUB( MPI_Type_create_f90_complex )( MPI_Fint* p,
                                     MPI_Fint* r,
                                     MPI_Fint* newtype,
                                     int*      ierr )
{
 ...
 */
void
FSUB( MPI_Type_create_f90_integer )( MPI_Fint* r,
                                     MPI_Fint* newtype,
                                     int*      ierr )
{
    MPI_Datatype c_newtype;
 ...
 */
void
FSUB( MPI_Type_create_f90_real )( MPI_Fint* p,
                                  MPI_Fint* r,
                                  MPI_Fint* newtype,
                                  int*      ierr )
{
