...
#if defined( HAVE_DECL_MPI_ABORT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
...
#endif
#if defined( HAVE_DECL_MPI_ACCUMULATE ) && !defined( SILC_MPI_NO_RMA )
...
#endif
#if defined( HAVE_DECL_MPI_ADD_ERROR_CLASS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if defined( HAVE_DECL_MPI_ADD_ERROR_CODE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ADD_ERROR_STRING ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ADDRESS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if defined( HAVE_DECL_MPI_ALLGATHER )
...
#endif
#if defined( HAVE_DECL_MPI_ALLGATHERV ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ALLOC_MEM ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ALLREDUCE ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ALLTOALL ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ALLTOALLV ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ATTR_DELETE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
...
#endif
#if defined( HAVE_DECL_MPI_ATTR_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ATTR_PUT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_BARRIER ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_BCAST ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_BSEND_INIT ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_BUFFER_ATTACH ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_BUFFER_DETACH ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CART_COORDS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
...
#endif
#if defined( HAVE_DECL_MPI_CART_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CART_MAP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CART_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CART_SHIFT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CART_SUB )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_CARTDIM_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if defined( HAVE_DECL_MPI_COMM_CALL_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if defined( HAVE_DECL_MPI_COMM_COMPARE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
...
#endif
#if defined( HAVE_DECL_MPI_COMM_CREATE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_CREATE_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_CREATE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_DELETE_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_DISCONNECT ) && !defined( SILC_MPI_NO_SPAWN ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_SPAWN )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_DUP )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_FREE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_FREE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_GET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_GET_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_GET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_GROUP )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_REMOTE_GROUP )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_REMOTE_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_SET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_SET_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_SET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_SPLIT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_COMM_TEST_INTER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_DIMS_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERRHANDLER_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERRHANDLER_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERRHANDLER_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERRHANDLER_SET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERROR_CLASS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ERROR_STRING ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_C2F ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if defined( HAVE_DECL_MPI_FILE_CALL_ERRHANDLER ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if defined( HAVE_DECL_MPI_FILE_CLOSE ) && !defined( SILC_MPI_NO_IO )
...
#endif
#if defined( HAVE_DECL_MPI_FILE_CREATE_ERRHANDLER ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_DELETE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_F2C ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_AMODE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_ATOMICITY ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_BYTE_OFFSET ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_ERRHANDLER ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_GROUP ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_INFO ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_POSITION ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_POSITION_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_SIZE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_TYPE_EXTENT ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_GET_VIEW ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IREAD ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IREAD_AT ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IREAD_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IWRITE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IWRITE_AT ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_IWRITE_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_OPEN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_PREALLOCATE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ALL ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ALL_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ALL_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_AT ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_AT_ALL ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_AT_ALL_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_AT_ALL_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ORDERED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ORDERED_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_ORDERED_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_READ_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SEEK ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SEEK_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SET_ATOMICITY ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SET_ERRHANDLER ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SET_INFO ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SET_SIZE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SET_VIEW ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_SYNC ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ALL ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ALL_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ALL_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_AT ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_AT_ALL ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_AT_ALL_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_AT_ALL_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ORDERED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ORDERED_BEGIN ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_ORDERED_END ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FILE_WRITE_SHARED ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FINALIZE )
...
#endif
#if defined( HAVE_DECL_MPI_FINALIZED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ENV )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ENV )
    {
...
#endif
#if defined( HAVE_DECL_MPI_FREE_MEM ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GATHER ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GATHERV ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET_ADDRESS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET_COUNT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET_ELEMENTS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET_PROCESSOR_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GET_VERSION ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPH_CREATE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPH_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPH_MAP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPH_NEIGHBORS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPH_NEIGHBORS_COUNT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GRAPHDIMS_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GREQUEST_COMPLETE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GREQUEST_START ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_COMPARE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_DIFFERENCE ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_EXCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_FREE ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_INCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_INTERSECTION ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_RANGE_EXCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_RANGE_INCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_TRANSLATE_RANKS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_GROUP_UNION ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_IBSEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_DELETE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_DUP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_GET_NKEYS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_GET_NTHKEY ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_GET_VALUELEN ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INFO_SET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INITIALIZED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ENV )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ENV )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INTERCOMM_CREATE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_INTERCOMM_MERGE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if defined( HAVE_DECL_MPI_IPROBE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_IRECV ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_IRSEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_IS_THREAD_MAIN ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ENV )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ENV )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ISEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_ISSEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_KEYVAL_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_KEYVAL_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_OP_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_OP_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_OP_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_OP_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_PACK_EXTERNAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_PACK_EXTERNAL_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_PACK_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_PROBE ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_PUT ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_QUERY_THREAD ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ENV )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ENV )
    {
...
#endif
#if defined( HAVE_DECL_MPI_RECV ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_RECV_INIT ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REDUCE ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REDUCE_SCATTER ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REGISTER_DATAREP ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REQUEST_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REQUEST_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_REQUEST_GET_STATUS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_RSEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_RSEND_INIT ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SCAN ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SCATTER ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SCATTERV ) && !defined( SILC_MPI_NO_COLL )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_COLL )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SEND_INIT ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SENDRECV ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SENDRECV_REPLACE ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SSEND ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_SSEND_INIT ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_START ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_STATUS_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_STATUS_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_STATUS_SET_CANCELLED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_STATUS_SET_ELEMENTS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TEST_CANCELLED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_P2P )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_P2P )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TOPO_TEST ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_COMMIT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CONTIGUOUS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_DARRAY ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_F90_COMPLEX ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_F90_INTEGER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_F90_REAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_HINDEXED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_HVECTOR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_INDEXED_BLOCK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_RESIZED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_CREATE_SUBARRAY ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_DELETE_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_DUP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_EXTENT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_MIC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_FREE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_GET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_GET_ENVELOPE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_GET_EXTENT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_GET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_GET_TRUE_EXTENT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_HINDEXED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_HVECTOR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_INDEXED ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_LB ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_MATCH_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_SET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_SET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_UB ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_TYPE_VECTOR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_UNPACK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_UNPACK_EXTERNAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_C2F ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_MISC ) && !defined( SILC_MPI_NO_EXTRA )
...
#endif
#if defined( HAVE_DECL_MPI_WIN_CALL_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if defined( HAVE_DECL_MPI_WIN_COMPLETE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_CREATE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_CREATE_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_CREATE_KEYVAL ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
...
#endif
#if defined( HAVE_DECL_MPI_WIN_DELETE_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_F2C ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_MISC ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_MISC )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_FENCE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_FREE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_FREE_KEYVAL ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_GET_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_GET_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_GET_GROUP ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_GET_NAME ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_LOCK ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_POST ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_SET_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_SET_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_SET_NAME ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_START ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_TEST ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_UNLOCK ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WIN_WAIT ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WTICK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if defined( HAVE_DECL_MPI_WTIME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
