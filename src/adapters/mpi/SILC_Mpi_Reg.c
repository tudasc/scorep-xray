...
#endif
#if HAVE( DECL_MPI_ACCUMULATE ) && !defined( SILC_MPI_NO_RMA )
...
#endif
#if HAVE( DECL_MPI_ADD_ERROR_CLASS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if HAVE( DECL_MPI_ADD_ERROR_CODE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ADD_ERROR_STRING ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ATTR_DELETE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
...
#endif
#if HAVE( DECL_MPI_ATTR_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_ATTR_PUT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_CART_COORDS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
...
#endif
#if HAVE( DECL_MPI_CART_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_CART_MAP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_CART_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_CART_SHIFT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_CARTDIM_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if HAVE( DECL_MPI_COMM_CALL_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if HAVE( DECL_MPI_COMM_COMPARE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
...
#endif
#if HAVE( DECL_MPI_COMM_CREATE_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_CREATE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_DELETE_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_DISCONNECT ) && !defined( SILC_MPI_NO_SPAWN ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_SPAWN )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_FREE_KEYVAL ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_GET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_GET_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_GET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_REMOTE_GROUP )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_REMOTE_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_SET_ATTR ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_SET_ERRHANDLER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_SET_NAME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_COMM_TEST_INTER ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_DIMS_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_ERRHANDLER_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ERRHANDLER_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ERRHANDLER_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ERRHANDLER_SET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ERROR_CLASS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_ERROR_STRING ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_FILE_C2F ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if HAVE( DECL_MPI_FILE_F2C ) && !defined( SILC_MPI_NO_IO ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_FILE_PREALLOCATE ) && !defined( SILC_MPI_NO_IO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_IO )
    {
...
#endif
#if HAVE( DECL_MPI_GET ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_GRAPH_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_GRAPH_MAP ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_GRAPH_NEIGHBORS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_GRAPH_NEIGHBORS_COUNT ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_GRAPHDIMS_GET ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_COMPARE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_DIFFERENCE ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_EXCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_FREE ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_INCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_INTERSECTION ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_RANGE_EXCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_RANGE_INCL ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_RANK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_SIZE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_TRANSLATE_RANKS ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_GROUP_UNION ) && !defined( SILC_MPI_NO_CG )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_INFO_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_INFO_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_INTERCOMM_CREATE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_INTERCOMM_MERGE )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG )
    {
...
#endif
#if HAVE( DECL_MPI_KEYVAL_CREATE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_KEYVAL_FREE ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_CG ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_CG_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_OP_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_OP_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_PUT ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_REQUEST_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_REQUEST_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_STATUS_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_STATUS_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_TOPO_TEST ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TOPO )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TOPO )
    {
...
#endif
#if HAVE( DECL_MPI_TYPE_C2F ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_MISC )
...
#endif
#if HAVE( DECL_MPI_TYPE_F2C ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_TYPE ) && !defined( SILC_MPI_NO_MISC )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_TYPE_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_C2F ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_MISC ) && !defined( SILC_MPI_NO_EXTRA )
...
#endif
#if HAVE( DECL_MPI_WIN_CALL_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
...
#endif
#if HAVE( DECL_MPI_WIN_COMPLETE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_CREATE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_CREATE_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_CREATE_KEYVAL ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
...
#endif
#if HAVE( DECL_MPI_WIN_DELETE_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_F2C ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_MISC ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_MISC )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_FENCE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_FREE ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_FREE_KEYVAL ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_GET_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_GET_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_GET_GROUP ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_GET_NAME ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_LOCK ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_POST ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_SET_ATTR ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_SET_ERRHANDLER ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_ERR )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_ERR )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_SET_NAME ) && !defined( SILC_MPI_NO_RMA ) && !defined( SILC_MPI_NO_EXT ) && !defined( SILC_MPI_NO_EXTRA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_START ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_TEST ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_UNLOCK ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WIN_WAIT ) && !defined( SILC_MPI_NO_RMA )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_RMA )
    {
...
#endif
#if HAVE( DECL_MPI_WTICK ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
...
#endif
#if HAVE( DECL_MPI_WTIME ) && !defined( SILC_MPI_NO_EXTRA ) && !defined( SILC_MPI_NO_MINI ) && !defined( SILC_MPI_NO_EXT )
    if ( silc_mpi_enabled & SILC_MPI_ENABLED_EXT )
    {
