...
(
    MPI_Comm_create
) ( MPI_Comm * comm, MPI_Group * group, MPI_Comm * newcomm, int* ierr )
{
...
(
    MPI_Comm_dup
) ( MPI_Comm * comm, MPI_Comm * newcomm, int* ierr )
{
...
(
    MPI_Comm_split
) ( MPI_Comm * comm, int* color, int* key, MPI_Comm * newcomm, int* ierr )
{
...
) ( MPI_Comm * local_comm, int* local_leader, MPI_Comm * peer_comm, int* remote_leader, int* tag, MPI_Comm * newcomm, int* ierr )
{
...
(
    MPI_Intercomm_merge
) ( MPI_Comm * intercomm, int* high, MPI_Comm * newcomm, int* ierr )
{
...
) ( MPI_Group * group1, MPI_Group * group2, MPI_Group * newgroup, int* ierr )
{
...
(
    MPI_Group_excl
) ( MPI_Group * group, int* n, int* ranks, MPI_Group * newgroup, int* ierr )
{
...
) ( MPI_Group * group, int* n, int ranges[][ 3 ], MPI_Group * newgroup, int* ierr )
{
...
(
    MPI_Comm_group
) ( MPI_Comm * comm, MPI_Group * group, int* ierr )
{
...
(
    MPI_Comm_compare
) ( MPI_Comm * comm1, MPI_Comm * comm2, int* result, int* ierr )
{
...
(
    MPI_Comm_rank
) ( MPI_Comm * comm, int* rank, int* ierr )
{
...
(
    MPI_Comm_size
) ( MPI_Comm * comm, int* size, int* ierr )
{
...
(
    MPI_Comm_test_inter
) ( MPI_Comm * comm, int* flag, int* ierr )
{
...
(
    MPI_Group_compare
) ( MPI_Group * group1, MPI_Group * group2, int* result, int* ierr )
{
...
(
    MPI_Group_rank
) ( MPI_Group * group, int* rank, int* ierr )
{
...
(
    MPI_Group_size
) ( MPI_Group * group, int* size, int* ierr )
{
...
) ( MPI_Comm * comm, int* errorcode, int* ierr )
{
...
) ( MPI_Comm_errhandler_fn * function, MPI_Errhandler * errhandler, int* ierr )
{
...
) ( MPI_Comm * comm, MPI_Errhandler * errhandler, int* ierr )
{
...
(
    MPI_Attr_delete
) ( MPI_Comm * comm, int* keyval, int* ierr )
{
...
(
    MPI_Attr_get
) ( MPI_Comm * comm, int* keyval, void* attribute_val, int* flag, int* ierr )
{
...
(
    MPI_Attr_put
) ( MPI_Comm * comm, int* keyval, void* attribute_val, int* ierr )
{
...
) ( MPI_Comm_copy_attr_function * comm_copy_attr_fn, MPI_Comm_delete_attr_function * comm_delete_attr_fn, int* comm_keyval, void* extra_state, int* ierr )
{
...
) ( MPI_Comm * comm, int* comm_keyval, int* ierr )
{
...
(
    MPI_Comm_get_attr
) ( MPI_Comm * comm, int* comm_keyval, void* attribute_val, int* flag, int* ierr )
{
...
(
    MPI_Comm_get_name
) ( MPI_Comm * comm, char* comm_name, int* resultlen, int* ierr, int comm_name_len )
{
...
(
    MPI_Comm_set_attr
) ( MPI_Comm * comm, int* comm_keyval, void* attribute_val, int* ierr )
{
...
(
    MPI_Comm_set_name
) ( MPI_Comm * comm, char* comm_name, int* ierr, int comm_name_len )
{
    char* c_comm_name = NULL;
    c_comm_name = ( char* )malloc( ( comm_name_len + 1 ) * sizeof( char ) );
    if ( !c_comm_name )
...
(
    MPI_Keyval_create
) ( MPI_Copy_function * copy_fn, MPI_Delete_function * delete_fn, int* keyval, void* extra_state, int* ierr )
{
...
(
    MPI_Comm_create
) ( MPI_Fint * comm, MPI_Fint * group, MPI_Fint * newcomm, int* ierr )
{
    MPI_Comm c_newcomm;
...
(
    MPI_Comm_dup
) ( MPI_Fint * comm, MPI_Fint * newcomm, int* ierr )
{
    MPI_Comm c_newcomm;
...
(
    MPI_Comm_split
) ( MPI_Fint * comm, MPI_Fint * color, MPI_Fint * key, MPI_Fint * newcomm, int* ierr )
{
    MPI_Comm c_newcomm;
...
(
    MPI_Intercomm_create
) ( MPI_Fint * local_comm, MPI_Fint * local_leader, MPI_Fint * peer_comm, MPI_Fint * remote_leader, MPI_Fint * tag, MPI_Fint * newcomm, int* ierr )
{
    MPI_Comm c_newcomm;
...
(
    MPI_Intercomm_merge
) ( MPI_Fint * intercomm, MPI_Fint * high, MPI_Fint * newcomm, int* ierr )
{
    MPI_Comm c_newcomm;
...
(
    MPI_Group_difference
) ( MPI_Fint * group1, MPI_Fint * group2, MPI_Fint * newgroup, int* ierr )
{
...
(
    MPI_Group_excl
) ( MPI_Fint * group, MPI_Fint * n, MPI_Fint * ranks, MPI_Fint * newgroup, int* ierr )
{
    MPI_Group c_newgroup;
...
(
    MPI_Group_range_excl
) ( MPI_Fint * group, MPI_Fint * n, MPI_Fint ranges[][ 3 ], MPI_Fint * newgroup, int* ierr )
{
    MPI_Group c_newgroup;
...
(
    MPI_Comm_group
) ( MPI_Fint * comm, MPI_Fint * group, int* ierr )
{
    MPI_Group c_group;
...
(
    MPI_Comm_compare
) ( MPI_Fint * comm1, MPI_Fint * comm2, MPI_Fint * result, int* ierr )
{
...
(
    MPI_Comm_rank
) ( MPI_Fint * comm, MPI_Fint * rank, int* ierr )
{
...
(
    MPI_Comm_size
) ( MPI_Fint * comm, MPI_Fint * size, int* ierr )
{
...
(
    MPI_Comm_test_inter
) ( MPI_Fint * comm, MPI_Fint * flag, int* ierr )
{
...
(
    MPI_Group_compare
) ( MPI_Fint * group1, MPI_Fint * group2, MPI_Fint * result, int* ierr )
{
...
(
    MPI_Group_rank
) ( MPI_Fint * group, MPI_Fint * rank, int* ierr )
{
...
(
    MPI_Group_size
) ( MPI_Fint * group, MPI_Fint * size, int* ierr )
{
...
(
    MPI_Comm_call_errhandler
) ( MPI_Fint * comm, MPI_Fint * errorcode, int* ierr )
{
...
(
    MPI_Comm_get_errhandler
) ( MPI_Fint * comm, void* errhandler, int* ierr )
{
...
(
    MPI_Attr_delete
) ( MPI_Fint * comm, MPI_Fint * keyval, int* ierr )
{
...
(
    MPI_Attr_get
) ( MPI_Fint * comm, MPI_Fint * keyval, void* attribute_val, MPI_Fint * flag, int* ierr )
{
...
(
    MPI_Attr_put
) ( MPI_Fint * comm, MPI_Fint * keyval, void* attribute_val, int* ierr )
{
...
(
    MPI_Comm_create_keyval
) ( void* comm_copy_attr_fn, void* comm_delete_attr_fn, MPI_Fint * comm_keyval, void* extra_state, int* ierr )
{
...
(
    MPI_Comm_delete_attr
) ( MPI_Fint * comm, MPI_Fint * comm_keyval, int* ierr )
{
    MPI_Comm c_comm = PMPI_Comm_f2c( *comm );
...
(
    MPI_Comm_get_attr
) ( MPI_Fint * comm, MPI_Fint * comm_keyval, void* attribute_val, MPI_Fint * flag, int* ierr )
{
...
(
    MPI_Comm_get_name
) ( MPI_Fint * comm, char* comm_name, MPI_Fint * resultlen, int* ierr, int comm_name_len )
{
    char* c_comm_name = NULL;
    c_comm_name = ( char* )malloc( ( comm_name_len + 1 ) * sizeof( char ) );
    if ( !c_comm_name )
...
(
    MPI_Comm_set_attr
) ( MPI_Fint * comm, MPI_Fint * comm_keyval, void* attribute_val, int* ierr )
{
    MPI_Comm c_comm = PMPI_Comm_f2c( *comm );
...
(
    MPI_Comm_set_name
) ( MPI_Fint * comm, char* comm_name, int* ierr, int comm_name_len )
{
    char*    c_comm_name = NULL;
    MPI_Comm c_comm      = PMPI_Comm_f2c( *comm );
    c_comm_name = ( char* )malloc( ( comm_name_len + 1 ) * sizeof( char ) );
...
(
    MPI_Keyval_create
) ( void* copy_fn, void* delete_fn, MPI_Fint * keyval, void* extra_state, int* ierr )
{
