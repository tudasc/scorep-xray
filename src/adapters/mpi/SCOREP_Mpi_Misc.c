                    ...
                    int*     nkeys )
{
    ...
    {
        SCOREP_MPI_EVENT_GEN_OFF();
        SCOREP_EnterRegion( scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NKEYS ] );

        return_val = PMPI_Info_get_nkeys( info, nkeys );

        SCOREP_ExitRegion( scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NKEYS ] );
        SCOREP_MPI_EVENT_GEN_ON();
    }
    else
    {
                     ...
                     char*    key )
{
    ...
    {
        SCOREP_MPI_EVENT_GEN_OFF();
        SCOREP_EnterRegion( scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NTHKEY ] );

        return_val = PMPI_Info_get_nthkey( info, n, key );

        SCOREP_ExitRegion( scorep_mpi_regid[ SCOREP__MPI_INFO_GET_NTHKEY ] );
        SCOREP_MPI_EVENT_GEN_ON();
    }
    else
    {
