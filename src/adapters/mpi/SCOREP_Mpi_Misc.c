...
/**
 * Declaration of PMPI-symbol for MPI_Errhandler_c2f
 */
MPI_Fint
PMPI_Errhandler_c2f( MPI_Errhandler errhandler );

/**
 * Measurement wrapper for MPI_Errhandler_c2f
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-2.1
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Errhandler_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Errhandler_c2f( MPI_Errhandler errhandler )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_C2F ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Errhandler_c2f( errhandler );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Errhandler_f2c
 */
MPI_Errhandler
PMPI_Errhandler_f2c( MPI_Fint errhandler );

/**
 * Measurement wrapper for MPI_Errhandler_f2c
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-2.1
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Errhandler_f2c call with enter and exit events.
 */
MPI_Errhandler
MPI_Errhandler_f2c( MPI_Fint errhandler )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_F2C ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Errhandler_f2c( errhandler );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_ERRHANDLER_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Message_c2f
 */
MPI_Fint
PMPI_Message_c2f( MPI_Message message );

/**
 * Measurement wrapper for MPI_Message_c2f
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-3.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Message_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Message_c2f( MPI_Message message )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_C2F ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Message_c2f( message );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Message_f2c
 */
MPI_Message
PMPI_Message_f2c( MPI_Fint message );

/**
 * Measurement wrapper for MPI_Message_f2c
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-3.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Message_f2c call with enter and exit events.
 */
MPI_Message
MPI_Message_f2c( MPI_Fint message )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_F2C ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Message_f2c( message );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_MESSAGE_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Op_c2f
 */
MPI_Fint
PMPI_Op_c2f( MPI_Op op );
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Op_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Op_c2f( MPI_Op op )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_C2F ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Op_f2c
 */
MPI_Op
PMPI_Op_f2c( MPI_Fint op );
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Op_f2c call with enter and exit events.
 */
MPI_Op
MPI_Op_f2c( MPI_Fint op )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_F2C ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_OP_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Request_c2f
 */
MPI_Fint
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Request_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Request_c2f( MPI_Request request )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_C2F ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Request_f2c
 */
MPI_Request
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Request_f2c call with enter and exit events.
 */
MPI_Request
MPI_Request_f2c( MPI_Fint request )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_F2C ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_REQUEST_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Session_c2f
 */
MPI_Fint
PMPI_Session_c2f( MPI_Session session );

/**
 * Measurement wrapper for MPI_Session_c2f
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-4.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Session_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Session_c2f( MPI_Session session )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_C2F ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Session_c2f( session );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Session_f2c
 */
MPI_Session
PMPI_Session_f2c( MPI_Fint session );

/**
 * Measurement wrapper for MPI_Session_f2c
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-4.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Session_f2c call with enter and exit events.
 */
MPI_Session
MPI_Session_f2c( MPI_Fint session )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_F2C ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Session_f2c( session );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_SESSION_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Status_c2f
 */
int
PMPI_Status_c2f( SCOREP_MPI_CONST_DECL MPI_Status* c_status,
                 MPI_Fint*                         f_status );
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Status_c2f call with enter and exit events.
 */
int
MPI_Status_c2f( SCOREP_MPI_CONST_DECL MPI_Status* c_status, MPI_Fint* f_status )
{
    SCOREP_IN_MEASUREMENT_INCREMENT();
    const int event_gen_active           = SCOREP_MPI_IS_EVENT_GEN_ON;
    const int event_gen_active_for_group = SCOREP_MPI_IS_EVENT_GEN_ON_FOR( SCOREP_MPI_ENABLED_MISC );
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Status_c2f08
 */
int
PMPI_Status_c2f08( const MPI_Status* c_status,
                   MPI_F08_status*   f08_status );

/**
 * Measurement wrapper for MPI_Status_c2f08
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-4.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Status_c2f08 call with enter and exit events.
 */
int
MPI_Status_c2f08( const MPI_Status* c_status, MPI_F08_status* f08_status )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F08 ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F08 ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Status_c2f08( c_status, f08_status );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F08 ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_C2F08 ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
MPI_Status_f082c( const MPI_F08_status* f08_status, MPI_Status* c_status )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082C ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Status_f082c( f08_status, c_status );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Status_f082f
 */
int
PMPI_Status_f082f( const MPI_F08_status* f08_status,
                   MPI_Fint*             f_status );

/**
 * Measurement wrapper for MPI_Status_f082f
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-4.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Status_f082f call with enter and exit events.
 */
int
MPI_Status_f082f( const MPI_F08_status* f08_status, MPI_Fint* f_status )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082F ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Status_f082f( f08_status, f_status );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F082F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Status_f2c
 */
int
PMPI_Status_f2c( SCOREP_MPI_CONST_DECL MPI_Fint* f_status,
                 MPI_Status*                     c_status );
 ...
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Status_f2c call with enter and exit events.
 */
int
MPI_Status_f2c( SCOREP_MPI_CONST_DECL MPI_Fint* f_status, MPI_Status* c_status )
{
    SCOREP_IN_MEASUREMENT_INCREMENT();
    const int event_gen_active           = SCOREP_MPI_IS_EVENT_GEN_ON;
    const int event_gen_active_for_group = SCOREP_MPI_IS_EVENT_GEN_ON_FOR( SCOREP_MPI_ENABLED_MISC );
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2C ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Status_f2f08
 */
int
PMPI_Status_f2f08( const MPI_Fint* f_status,
                   MPI_F08_status* f08_status );

/**
 * Measurement wrapper for MPI_Status_f2f08
 * @note Auto-generated by wrapgen from template: SCOREP_Mpi_Std.w
 * @note C interface
 * @note Introduced with MPI-4.0
 * @ingroup misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Status_f2f08 call with enter and exit events.
 */
int
MPI_Status_f2f08( const MPI_Fint* f_status, MPI_F08_status* f08_status )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2F08 ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2F08 ] );
        }
    }

    SCOREP_ENTER_WRAPPED_REGION();
    return_val = PMPI_Status_f2f08( f_status, f08_status );
    SCOREP_EXIT_WRAPPED_REGION();
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2F08 ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_STATUS_F2F08 ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
