 ...
 * @li enter region 'MPI': Only if this adapter initializes the measurement system.
...
MPI_Init( int* argc, char*** argv )
{
    ...
    if ( !SCOREP_IsInitialized() )
    {
        ...
        SCOREP_EnterRegion( scorep_mpi_regid[ SCOREP__MPI_ARTIFICIAL_ROOT ] );

        /* Remember that SCOREP__MPI_ARTIFICIAL_ROOT was entered */
...
MPI_Finalize()
{
    ...
    if ( event_gen_active )
    {
        ...
        {
            SCOREP_ExitRegion( scorep_mpi_regid[ SCOREP__MPI_ARTIFICIAL_ROOT ] );
        }
