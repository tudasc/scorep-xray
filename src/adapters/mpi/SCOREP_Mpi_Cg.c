 ...
 * It wraps the MPI_Comm_create_from_group call with enter and exit events.
 */
int
 ...
 * @ingroup cg
 * Triggers an enter and exit event.
 * It wraps the MPI_Intercomm_create_from_groups call with enter and exit events.
 */
int
 ...
 * @ingroup cg
 * Triggers an enter and exit event.
 * It wraps the MPI_Group_from_session_pset call with enter and exit events.
 */
int
