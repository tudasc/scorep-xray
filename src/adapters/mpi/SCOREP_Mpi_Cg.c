 ...
 *
 * Copyright (c) 2009-2015, 2020, 2022-2023,
...
/**
 * Declaration of PMPI-symbol for MPI_Comm_c2f
 */
MPI_Fint
PMPI_Comm_c2f( MPI_Comm comm );
 ...
 * @ingroup cg_misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Comm_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Comm_c2f( MPI_Comm comm )
{
    SCOREP_IN_MEASUREMENT_INCREMENT();
    const int event_gen_active           = SCOREP_MPI_IS_EVENT_GEN_ON;
    const int event_gen_active_for_group = SCOREP_MPI_IS_EVENT_GEN_ON_FOR( SCOREP_MPI_ENABLED_CG_MISC );
    MPI_Fint  return_val;
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_C2F ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Comm_f2c
 */
MPI_Comm
PMPI_Comm_f2c( MPI_Fint comm );
 ...
 * @ingroup cg_misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Comm_f2c call with enter and exit events.
 */
MPI_Comm
MPI_Comm_f2c( MPI_Fint comm )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_F2C ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_COMM_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Group_c2f
 */
MPI_Fint
 ...
 * @ingroup cg_misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Group_c2f call with enter and exit events.
 */
MPI_Fint
MPI_Group_c2f( MPI_Group group )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_C2F ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_C2F ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_C2F ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
...
/**
 * Declaration of PMPI-symbol for MPI_Group_f2c
 */
MPI_Group
 ...
 * @ingroup cg_misc
 * Triggers an enter and exit event.
 * It wraps the MPI_Group_f2c call with enter and exit events.
 */
MPI_Group
MPI_Group_f2c( MPI_Fint group )
{
    ...
    if ( event_gen_active )
    {
        ...
        if ( event_gen_active_for_group )
        {
            SCOREP_EnterWrappedRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_EnterWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_F2C ] );
        }
    }
    ...
    if ( event_gen_active )
    {
        if ( event_gen_active_for_group )
        {
            SCOREP_ExitRegion( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_F2C ] );
        }
        else if ( SCOREP_IsUnwindingEnabled() )
        {
            SCOREP_ExitWrapper( scorep_mpi_regions[ SCOREP_MPI_REGION__MPI_GROUP_F2C ] );
        }
        SCOREP_MPI_EVENT_GEN_ON();
    }
