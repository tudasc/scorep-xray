...
#ifndef SILC_POMP2_FORTRAN_H
#define SILC_POMP2_FORTRAN_H
...
#define SILC_POMP_F2C_REGION( handle ) ( ( POMP2_Region_handle* )SILC_F2C_POINTER( handle ) )
